(function () {
  ...
  // La figura è vista di fronte: il lato sinistro dello schermo
  // corrisponde al lato DESTRO della persona (vista a specchio).
  var ZONES = [
    ...
    { id: 'r-arm',   label: 'braccio destro',     shape: 'rect',   attrs: { x:20,  y:90,  width:33, height:100, rx:10 } },
    { id: 'l-arm',   label: 'braccio sinistro',   shape: 'rect',   attrs: { x:147, y:90,  width:33, height:100, rx:10 } },
    { id: 'r-hand',  label: 'mano destra',        shape: 'rect',   attrs: { x:14,  y:192, width:38, height:28, rx:8 } },
    { id: 'l-hand',  label: 'mano sinistra',      shape: 'rect',   attrs: { x:148, y:192, width:38, height:28, rx:8 } },
    { id: 'r-thigh', label: 'coscia destra',      shape: 'rect',   attrs: { x:57,  y:242, width:38, height:78, rx:8 } },
    { id: 'l-thigh', label: 'coscia sinistra',    shape: 'rect',   attrs: { x:105, y:242, width:38, height:78, rx:8 } },
    { id: 'r-calf',  label: 'polpaccio destro',   shape: 'rect',   attrs: { x:59,  y:322, width:34, height:72, rx:8 } },
    { id: 'l-calf',  label: 'polpaccio sinistro', shape: 'rect',   attrs: { x:107, y:322, width:34, height:72, rx:8 } },
    { id: 'r-foot',  label: 'piede destro',       shape: 'rect',   attrs: { x:42,  y:396, width:50, height:24, rx:8 } },
    { id: 'l-foot',  label: 'piede sinistro',     shape: 'rect',   attrs: { x:108, y:396, width:50, height:24, rx:8 } },
  ];
